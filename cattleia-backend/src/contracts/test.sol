    ...
    ERC20Permit
{
    ...
    uint256 public constant MAX_DAILY_MINTING_AMOUNT = 2000000 ether;
    uint256 private _daily_minting_amount = MAX_DAILY_MINTING_AMOUNT;
    uint256 public nextMintingDate;

    // Test values
    address public constant TEAM_ADDRESS =
        0x460e5429894ADCebD53918f88cc408D4575f4A5b;
    address public constant INVESTOR_ADDRESS =
        0x6F73Dcf51f5794E5ba1DD19953928119c1289aA2;
    address public constant AIRDROP_ADDRESS =
        0x25F719508790923D6d9910ccBF4510CF49635674;
    ...
    function mint(address to, uint256 amount) public virtual {
        ...
        require(
            amount <= MAX_DAILY_MINTING_AMOUNT,
            "CoinaryToken: The amount is highest than the MAX_DAILY_MINTING_AMOUNT"
        );
        require(
            amount <= _daily_minting_amount,
            "CoinaryToken: The amount is highest than the daily_minting_amount"
        );
        require(
            block.timestamp >= nextMintingDate,
            "CoinaryToken: You must wait 24 hours until the next minting"
        );
    ...
    function dailyMintingAmount() public view virtual returns (uint256) {
